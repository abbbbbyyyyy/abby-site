 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(z,M){var N=z.length;z.push(M);e:for(;0<N;){var _=N-1>>>1,L=z[_];if(0<i(L,M))z[_]=M,z[N]=L,N=_;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var M=z[0],N=z.pop();if(N!==M){z[0]=N;e:for(var _=0,L=z.length,Z=L>>>1;_<Z;){var lt=2*(_+1)-1,jt=z[lt],Bt=lt+1,fr=z[Bt];if(0>i(jt,N))Bt<L&&0>i(fr,jt)?(z[_]=fr,z[Bt]=N,_=Bt):(z[_]=jt,z[lt]=N,_=lt);else if(Bt<L&&0>i(fr,N))z[_]=fr,z[Bt]=N,_=Bt;else break e}}return M}function i(z,M){var N=z.sortIndex-M.sortIndex;return N!==0?N:z.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();e.unstable_now=function(){return s.now()-l}}var u=[],c=[],h=1,m=null,g=3,y=!1,v=!1,x=!1,A=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(z){for(var M=n(c);M!==null;){if(M.callback===null)r(c);else if(M.startTime<=z)r(c),M.sortIndex=M.expirationTime,t(u,M);else break;M=n(c)}}function w(z){if(x=!1,p(z),!v)if(n(u)!==null)v=!0,ee(S);else{var M=n(c);M!==null&&We(w,M.startTime-z)}}function S(z,M){v=!1,x&&(x=!1,f(I),I=-1),y=!0;var N=g;try{for(p(M),m=n(u);m!==null&&(!(m.expirationTime>M)||z&&!P());){var _=m.callback;if(typeof _=="function"){m.callback=null,g=m.priorityLevel;var L=_(m.expirationTime<=M);M=e.unstable_now(),typeof L=="function"?m.callback=L:m===n(u)&&r(u),p(M)}else r(u);m=n(u)}if(m!==null)var Z=!0;else{var lt=n(c);lt!==null&&We(w,lt.startTime-M),Z=!1}return Z}finally{m=null,g=N,y=!1}}var C=!1,R=null,I=-1,j=5,B=-1;function P(){return!(e.unstable_now()-B<j)}function J(){if(R!==null){var z=e.unstable_now();B=z;var M=!0;try{M=R(!0,z)}finally{M?ne():(C=!1,R=null)}}else C=!1}var ne;if(typeof d=="function")ne=function(){d(J)};else if(typeof MessageChannel<"u"){var re=new MessageChannel,ie=re.port2;re.port1.onmessage=J,ne=function(){ie.postMessage(null)}}else ne=function(){A(J,0)};function ee(z){R=z,C||(C=!0,ne())}function We(z,M){I=A(function(){z(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(z){z.callback=null},e.unstable_continueExecution=function(){v||y||(v=!0,ee(S))},e.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<z?Math.floor(1e3/z):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(z){switch(g){case 1:case 2:case 3:var M=3;break;default:M=g}var N=g;g=M;try{return z()}finally{g=N}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(z,M){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var N=g;g=z;try{return M()}finally{g=N}},e.unstable_scheduleCallback=function(z,M,N){var _=e.unstable_now();switch(typeof N=="object"&&N!==null?(N=N.delay,N=typeof N=="number"&&0<N?_+N:_):N=_,z){case 1:var L=-1;break;case 2:L=250;break;case 5:L=1073741823;break;case 4:L=1e4;break;default:L=5e3}return L=N+L,z={id:h++,callback:M,priorityLevel:z,startTime:N,expirationTime:L,sortIndex:-1},N>_?(z.sortIndex=N,t(c,z),n(u)===null&&z===n(c)&&(x?(f(I),I=-1):x=!0,We(w,N-_))):(z.sortIndex=L,t(u,z),v||y||(v=!0,ee(S))),z},e.unstable_shouldYield=P,e.unstable_wrapCallback=function(z){var M=g;return function(){var N=g;g=M;try{return z.apply(this,arguments)}finally{g=N}}}})(_a);Ma.exports=_a;var gd=Ma.exports;/**
 * @license React
...
`,um=[{role:"Project Manager",org:"Dalio Family Office (prev. Bridgewater Associates)",date:"Jan 2022 – May 2025",bullets:["Rebuilt and owned the Annual Strategic Planning Program across 15 teams over 3 years, transforming a broken, inconsistent process into a repeatable org-wide system. Led each team through KPI development, metric definition, and priority project identification; synthesized outputs into org-wide project portfolio of 80–100 active initiatives. Maintained visibility into dependencies and resource constraints; advised senior leadership on prioritization and sequencing tradeoffs. Partnered with Finance on annual budgeting process across all teams. Built automated dashboards tracking KPIs org-wide, replacing ad-hoc status updates with standardized monthly reporting to senior leadership.","Led the organization’s highest-complexity annual program ($8–10M budget, 2,000+ stakeholders, 12 vendors): managed end-to-end execution including vendor sourcing, production, logistics coordination, a parallel charitable giving initiative, and real-time shipment tracking. Internally recognized as the most operationally demanding program at the org.","Deployed as internal process consultant across the organization: diagnosed operational bottlenecks, documented current-state workflows, designed and implemented improvements. Reduced average process cycle times by 30–40% across engagements; cut manual reporting work by 50%+ in several teams.","Established documentation standards across the organization. Created playbooks, SOPs, and process guides for every initiative touched, building knowledge management infrastructure essentially from scratch in an org with minimal existing documentation."]},{role:"Business Analyst / Junior Project Manager",org:"Bridgewater Associates",date:"Mar 2019 – Jan 2022",bullets:["Designed and owned a cross-departmental culture measurement initiative from scratch: built survey instrument, ran quantitative and qualitative analysis across 500+ respondents, delivered findings to leadership that informed policy changes and measurably improved engagement scores.","Served as analytical partner to business leads across departments: synthesized performance data to surface risks early, identify trends, and translate insights into actionable recommendations for leadership.","Led change management for CRM system upgrade across 200+ users: developed communications plan, created training materials, managed user acceptance testing, and drove full rollout. Achieved 95%+ adoption within first month.","Deployed as surge resource to Talent Acquisition during high-volume hiring periods: managed interview coordination, conducted candidate interviews, and contributed to hiring decisions across multiple roles.","Built internal knowledge management systems and onboarding documentation that reduced new hire ramp time by 40% and improved cross-team process consistency."]}],cm=[{role:"Research Assistant",org:"Teachers College, Columbia University",date:"2025 – Present",bullets:["Researching how AI-mediated decision support tools affect human reasoning, with direct applications to AI product design and user behavior.","Contributing to study design and methodology; independently conducted comparative analysis of how different AI models approach complex decision-making tasks."]}],dm="Built from scratch with zero prior coding experience using Claude Code, Cursor, React, and Vercel.",fm=[{name:"Crux",description:"AI decision-making tool that analyzes choices and surfaces core tensions. Claude API, React."},{name:"What’s Your Alibi",description:"Excuse generator that crafts context-aware, believable alternatives to “not feeling well.”"},{name:"Gut Check",description:"Personality assessment disguised as a game. Rapid-fire scenarios reveal decision-making patterns."}],pm=[{degree:"M.A. Social-Organizational Psychology",school:"Teachers College, Columbia University",year:"Expected 2027"},{degree:"B.A. Psychology",school:"Lehigh University",year:"2018"}],mm=["AI-Assisted Development (Claude Code, Cursor)","Claude API","React","GitHub & Vercel","SQL (Snowflake, BigQuery)","Data Visualization (Tableau, Looker, PowerBI)","Excel","Strategic Planning","Program Management","Process Design & Optimization","Change Management","Survey Design & Research Methods"];function ga({entry:e}){return a.jsxs("div",{className:"resume-entry",children:[a.jsxs("div",{className:"resume-entry-header",children:[a.jsxs("div",{className:"resume-role",children:[e.role," ",a.jsxs("em",{children:["| ",e.org]})]}),a.jsx("div",{className:"resume-meta",children:e.date})]}),a.jsx("ul",{className:"resume-bullets",children:e.bullets.map((t,n)=>a.jsx("li",{children:t},n))})]})}function hm({onHover:e}){const t=e||(()=>{}),[n,r]=b.useState(null);return b.useEffect(()=>{Promise.all([document.fonts.load("italic 400 160px 'Instrument Serif'"),document.fonts.load("400 320px 'Gravitas One'")]).then(()=>{const i=document.createElement("canvas");i.width=3200,i.height=600;const o=i.getContext("2d");o.fillStyle="#ffffff",o.textAlign="center",o.font="italic 400 220px 'Instrument Serif'",o.fillText("Abby",1600,230),o.font="400 260px 'Gravitas One'",o.fillText("SCHNEIDER",1600,490),r(i.toDataURL())})},[]),a.jsxs(a.Fragment,{children:[a.jsx("style",{children:am}),a.jsxs("div",{className:"resume",children:[a.jsx("h1",{className:"sr-only",children:"Abby Schneider"}),n&&a.jsx("div",{className:"resume-name-metal",children:a.jsx(qp,{width:3200,height:600,image:n,colorBack:"#0a0f0a",colorTint:"#e8e0d0",shape:"none",speed:.15,style:{width:"100%",height:"100%"}})}),a.jsxs("div",{className:"resume-header",children:[a.jsxs("div",{className:"resume-contact",children:[a.jsx("a",{href:"mailto:abbyschneider4@gmail.com",onMouseEnter:()=>t(!0),onMouseLeave:()=>t(!1),children:"abbyschneider4@gmail.com"}),a.jsx("span",{className:"sep",children:"·"}),a.jsx("span",{children:"Brooklyn, NY"}),a.jsx("span",{className:"sep",children:"·"}),a.jsx("span",{children:"203-858-5241"})]}),a.jsx("a",{href:"/Abby_Schneider_Resume.pdf",download:!0,className:"resume-download",onMouseEnter:()=>t(!0),onMouseLeave:()=>t(!1),children:"Download PDF"})]}),a.jsxs("div",{className:"resume-section",children:[a.jsx("div",{className:"resume-section-title",children:"[Experience]"}),um.map((i,o)=>a.jsx(ga,{entry:i},o))]}),a.jsxs("div",{className:"resume-section",children:[a.jsx("div",{className:"resume-section-title",children:"[Research]"}),cm.map((i,o)=>a.jsx(ga,{entry:i},o))]}),a.jsxs("div",{className:"resume-section",children:[a.jsx("div",{className:"resume-section-title",children:"[Personal Projects]"}),a.jsx("div",{className:"resume-project-desc",style:{marginBottom:16,fontStyle:"italic"},children:dm}),fm.map((i,o)=>a.jsxs("div",{className:"resume-project-item",children:[a.jsx("div",{className:"resume-project-name",children:i.name}),a.jsx("div",{className:"resume-project-desc",children:i.description})]},o))]}),a.jsxs("div",{className:"resume-section",children:[a.jsx("div",{className:"resume-section-title",children:"[Education]"}),pm.map((i,o)=>a.jsxs("div",{className:"resume-edu-item",children:[a.jsxs("div",{className:"resume-edu-degree",children:[i.degree," ",a.jsxs("em",{children:["· ",i.school]})]}),a.jsx("div",{className:"resume-edu-year",children:i.year})]},o))]}),a.jsxs("div",{className:"resume-section",children:[a.jsx("div",{className:"resume-section-title",children:"[Skills & Tools]"}),a.jsx("div",{className:"resume-skills",children:mm.map((i,o)=>a.jsx(qe,{as:"span",className:"resume-skill",maxPixelCount:4e4,children:i},o))})]})]})]})}const va=["MINIMAL","LOW","MODERATE","ELEVATED","CRITICAL"],gm=[15,35,65,85,97],vm=`
  .memo {
    min-height: 100vh;
    background: #f4f1eb;
    color: #1a1a1a;
...
`;function bm(e){const[t,n,r]=e.split("-");return new Date(Number(t),Number(n)-1,Number(r)).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})}function Nm(){const[e,t]=b.useState(()=>sessionStorage.getItem("blog_auth")==="true"),[n,r]=b.useState(""),[i,o]=b.useState(!1),s=b.useRef(null);b.useEffect(()=>{!e&&s.current&&s.current.focus()},[e]);const l=u=>{u.preventDefault(),n===Em?(sessionStorage.setItem("blog_auth","true"),t(!0)):(o(!0),r(""),setTimeout(()=>o(!1),500))};return e?a.jsxs(a.Fragment,{children:[a.jsx("style",{children:xa}),a.jsx("div",{className:"blog-container",children:a.jsxs("div",{className:"blog-inner",children:[a.jsxs("div",{className:"blog-header",children:[a.jsx("div",{className:"blog-title",children:"Stream"}),a.jsx("div",{className:"blog-subtitle",children:"notes to self, shared selectively"})]}),Cm.map((u,c)=>a.jsxs("div",{className:"blog-post",children:[a.jsx("div",{className:"blog-post-date",children:bm(u.date)}),u.title&&a.jsx("div",{className:"blog-post-title",children:u.title}),a.jsx("div",{className:"blog-post-body",children:u.body})]},c))]})})]}):a.jsxs(a.Fragment,{children:[a.jsx("style",{children:xa}),a.jsxs("div",{className:"blog-gate",children:[a.jsx("div",{className:"blog-gate-title",children:"Stream"}),a.jsx("form",{onSubmit:l,children:a.jsx("input",{ref:s,type:"password",className:`blog-gate-input${i?" shake":""}`,placeholder:"password",value:n,onChange:u=>r(u.target.value),autoComplete:"off"})}),a.jsx("div",{className:"blog-gate-hint",children:"this one's private"})]})]})}const Rm=`#version 300 es
precision mediump float;
in vec2 a_pos;
out vec2 v_uv;
void main() {
