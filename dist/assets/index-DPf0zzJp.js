 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(z,M){var j=z.length;z.push(M);e:for(;0<j;){var _=j-1>>>1,L=z[_];if(0<i(L,M))z[_]=M,z[j]=L,j=_;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var M=z[0],j=z.pop();if(j!==M){z[0]=j;e:for(var _=0,L=z.length,$=L>>>1;_<$;){var st=2*(_+1)-1,jt=z[st],It=st+1,fr=z[It];if(0>i(jt,j))It<L&&0>i(fr,jt)?(z[_]=fr,z[It]=j,_=It):(z[_]=jt,z[st]=j,_=st);else if(It<L&&0>i(fr,j))z[_]=fr,z[It]=j,_=It;else break e}}return M}function i(z,M){var j=z.sortIndex-M.sortIndex;return j!==0?j:z.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();e.unstable_now=function(){return s.now()-l}}var a=[],c=[],h=1,m=null,g=3,y=!1,v=!1,x=!1,A=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(z){for(var M=n(c);M!==null;){if(M.callback===null)r(c);else if(M.startTime<=z)r(c),M.sortIndex=M.expirationTime,t(a,M);else break;M=n(c)}}function w(z){if(x=!1,p(z),!v)if(n(a)!==null)v=!0,ie(S);else{var M=n(c);M!==null&&Rt(w,M.startTime-z)}}function S(z,M){v=!1,x&&(x=!1,f(R),R=-1),y=!0;var j=g;try{for(p(M),m=n(a);m!==null&&(!(m.expirationTime>M)||z&&!F());){var _=m.callback;if(typeof _=="function"){m.callback=null,g=m.priorityLevel;var L=_(m.expirationTime<=M);M=e.unstable_now(),typeof L=="function"?m.callback=L:m===n(a)&&r(a),p(M)}else r(a);m=n(a)}if(m!==null)var $=!0;else{var st=n(c);st!==null&&Rt(w,st.startTime-M),$=!1}return $}finally{m=null,g=j,y=!1}}var N=!1,E=null,R=-1,T=5,I=-1;function F(){return!(e.unstable_now()-I<T)}function ve(){if(E!==null){var z=e.unstable_now();I=z;var M=!0;try{M=E(!0,z)}finally{M?xe():(N=!1,E=null)}}else N=!1}var xe;if(typeof d=="function")xe=function(){d(ve)};else if(typeof MessageChannel<"u"){var Ie=new MessageChannel,ae=Ie.port2;Ie.port1.onmessage=ve,xe=function(){ae.postMessage(null)}}else xe=function(){A(ve,0)};function ie(z){E=z,N||(N=!0,xe())}function Rt(z,M){R=A(function(){z(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(z){z.callback=null},e.unstable_continueExecution=function(){v||y||(v=!0,ie(S))},e.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<z?Math.floor(1e3/z):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(z){switch(g){case 1:case 2:case 3:var M=3;break;default:M=g}var j=g;g=M;try{return z()}finally{g=j}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(z,M){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var j=g;g=z;try{return M()}finally{g=j}},e.unstable_scheduleCallback=function(z,M,j){var _=e.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?_+j:_):j=_,z){case 1:var L=-1;break;case 2:L=250;break;case 5:L=1073741823;break;case 4:L=1e4;break;default:L=5e3}return L=j+L,z={id:h++,callback:M,priorityLevel:z,startTime:j,expirationTime:L,sortIndex:-1},j>_?(z.sortIndex=j,t(c,z),n(a)===null&&z===n(c)&&(x?(f(R),R=-1):x=!0,Rt(w,j-_))):(z.sortIndex=L,t(a,z),v||y||(v=!0,ie(S))),z},e.unstable_shouldYield=F,e.unstable_wrapCallback=function(z){var M=g;return function(){var j=g;g=M;try{return z.apply(this,arguments)}finally{g=j}}}})(Ia);ja.exports=Ia;var ad=ja.exports;/**
 * @license React
